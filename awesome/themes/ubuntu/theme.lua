-------------------------------
-- "ubuntu" awesome theme    --
-------------------------------
-- BASICS
local theme = {}

theme.dir           = os.getenv ("HOME") .. "/.config/awesome/themes/ubuntu/"
--theme.font          = "sans 8"
--theme.font          = "fixed 8"
theme.font          = "xos4 terminus italic 9"

theme.bg_focus      = "#92693b77"
theme.bg_normal     = "#2c2d1144"
theme.bg_urgent    = "#999b0055"
theme.bg_minimize   = "#58762722"
theme.bg_systray    = theme.bg_urgent

theme.fg_normal     = "#9e5850"
theme.fg_focus      = "#361461"
theme.fg_urgent     = "#cd5c5c"
theme.fg_minimize   = "#cd5c5c"

theme.useless_gap   = 0
theme.border_width  = 1
theme.border_normal  = "#2c2d11"
theme.border_focus  = "#92693b"
...
theme.wallpaper             = theme.dir .. "ubuntu.jpg"
--theme.wallpaper             = theme.dir .. "ubuntu-1.png"
