-------------------------------
--    "gentoo" awesome theme    --
-------------------------------
-- BASICS
local theme = {}

theme.dir           = os.getenv ("HOME") .. "/.config/awesome/themes/gentoo/"
--theme.font          = "sans 8"
--theme.font          = "fixed 8"
theme.font          = "xos4 terminus italic 9"

--theme.bg_focus      = "#e2eeea"
theme.bg_focus      = "#2f4f4f44"
theme.bg_normal     = "#b0c4de00" -- light stell blue
...
theme.border_focus  = "#708090" --state gray
...
--theme.wallpaper             = theme.dir .. "karta-1.jpg"
theme.wallpaper             = theme.dir .. "gentoo-1.jpg"
--theme.wallpaper             = theme.dir .. "black-1.png"
